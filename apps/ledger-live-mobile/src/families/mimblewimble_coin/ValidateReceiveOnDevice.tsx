...
function AmountField(
  ...
  return (
    <DataRowUnitValue label={"Amount"} unit={unit} value={amount} />
  );
}
...
function FeesField(
  ...
  return (
    <DataRowUnitValue label={"Fee"} unit={feesUnit} value={fee} />
  );
}
...
function TextField(
  ...
  return (
    <TextValueField label={label} value={value} />
  );
}
  ...
  return (
    <RootContainer>
      <ScrollContainer>
        <InnerContainer>
          <AnimationContainer>
            <Animation source={getDeviceAnimation({ device, key: "validate", theme: dark ? "dark" : "light" })} />
          </AnimationContainer>
          <TitleText>{t("mimblewimble_coin.confirmReceive", getDeviceModel(device.modelId))}</TitleText>
          <DataRowsContainer>
            <AmountField account={account} parentAccount={parentAccount} amount={amount} />
            <FeesField account={account} parentAccount={parentAccount} fee={fee} />
            <TextField label={"Kernel Features"} value={"Plain"} />
            <TextField label={"Sender Payment Proof Address"} value={(senderPaymentProofAddress !== null) ? senderPaymentProofAddress.trim() : "N/A"} />
          </DataRowsContainer>
        </InnerContainer>
      </ScrollContainer>
