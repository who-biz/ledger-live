...
export const cryptocurrenciesById: Record<string, CryptoCurrency> = {
  ...
  grin_testnet: {
    ...
    coinType: 1,
    name: "Grin Testnet",
    managerAppName: "Grin Testnet",
    ticker: "GRIN",
    disableCountervalue: true,
    scheme: "web+grintestnethttp",
    isTestnetFor: "grin",
    color: "#FEF102",
    family: "mimblewimble_coin",
    blockAvgTime: 60,
  ...
  mimblewimble_coin: {
    type: "CryptoCurrency",
    id: "mimblewimble_coin",
    coinType: 593,
    name: "MimbleWimble Coin",
    managerAppName: "MimbleWimble Coin",
    ticker: "MWC",
    scheme: "web+mwchttp",
    color: "#7A00D9",
    family: "mimblewimble_coin",
  ...
  mimblewimble_coin_floonet: {
    type: "CryptoCurrency",
    id: "mimblewimble_coin_floonet",
    coinType: 1,
    name: "MimbleWimble Coin Floonet",
    managerAppName: "MimbleWimble Coin Floonet",
    ticker: "MWC",
    disableCountervalue: true,
    scheme: "web+mwcfloonethttp",
    isTestnetFor: "mimblewimble_coin",
    color: "#7A00D9",
    family: "mimblewimble_coin",
    blockAvgTime: 60,
    units: [
